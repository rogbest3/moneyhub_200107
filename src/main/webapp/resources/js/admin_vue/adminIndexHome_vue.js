"use strict"
var adminIndexHome_vue = adminIndexHome_vue || {}
adminIndexHome_vue ={
	home_head : ()=>{
			return '<head>'+
			' <meta charset="utf-8">'+
	...
	home_body : d=>{
		...
		'                      <div class="h5 mb-0 font-weight-bold text-gray-800"><table><tbody id="memberNowCount"></tbody></table></div>'+
		'                    </div>'+
		'                  </div>'+
		'                </div>'+
		'              </div>'+
		...
		'                  <h6 class="m-0 font-weight-bold text-primary">일별 수수료 수익(단위 1만달러)</h6>'+
