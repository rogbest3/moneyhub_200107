...
buttons_vue ={
		...
		'                </div>'+
		'                <div class="card-body">'+
		'                  <p>Google and Facebook buttons are available featuring each companys respective brand color. They are used on the user login and registration pages.</p>'+
