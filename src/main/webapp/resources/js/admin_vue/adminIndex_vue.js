"use strict"
var adminIndex_vue = adminIndex_vue || {}
adminIndex_vue ={
	main_head : ()=>{
		return '<head>'+
		' <meta charset="utf-8">'+
	...
	main_body : x=>{
		...
		'     <!-- Nav Item - Tables -->'+
		'      <li class="nav-item">'+
		'        <a id="tables_a" class="nav-link" href="#">'+
...
//		'                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="'+x.img+'/undraw_posting_photo.svg" alt="">'+
		'                  </div>'+
