var utilities_animation_vue = utilities_animation_vue || {}
utilities_animation_vue ={
		utilities_animation : ()=>{
		return '<!DOCTYPE html>'+
		'<html lang="en">'+
		'<head>'+
		...
		'          <p class="mb-4">Bootstraps default utility classes can be found on the official <a href="https://getbootstrap.com/docs">Bootstrap Documentation</a> page. The custom utilities below were created to extend this theme past the default utility classes built into Bootstraps framework.</p>'+
		'         <!-- Content Row -->'+
		'          <div class="row">'+
		'           <!-- Grow In Utility -->'+
		'            <div class="col-lg-6">'+
