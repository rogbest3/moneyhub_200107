...
cards_vue ={
		...
		'                </div>'+
		'                <div class="card-body">'+
		'                  This card uses Bootstraps default styling with no utility classes added. Global styles are the only things modifying the look and feel of this default card example.'+
		'                </div>'+
		'              </div>'+
		'             <!-- Basic Card Example -->'+
