...
/*		'						<p style="margin: 33px auto 0px;"><a>이미 회원이신가요?</a></p>'+*/
	...
	join_2 : ()=>{
        ...
        +제1장 총칙
        +제1조 (목적)
        이 약관은 주식회사 머니허브(이하 "회사"라고 합니다)이 "머니허브" 인터넷 사이트(https://www.themoneyhub.com, m.themoneyhub.com 및 해당 모바일 사이트와 연결 사이트, 이하 "머니허브 사이트"라고 합니다)와 스마트폰 등 이동통신기기를 통해 제공되는 "머니허브" 모바일 애플리케이션(이하 "모바일 머니허브"이라고 합니다)을 통하여 제공하는 소액해외송금서비스(이하 "서비스"라고 합니다)와 관련하여 회사와 회원 간의 권리와 의무, 책임사항 및 회원의 서비스이용절차에 관한 사항을 규정함을 목적으로 합니다.
        +제2조 (용어의 정의)
        ...
        주식회사 머니허브(이하 “회사”)는 회사가 운영하는 인터넷 사이트(www.themoneyhub.com 및 해당 모바일 사이트와 연결 사이트), 스마트폰 등 이동통신기기를 통해 제공되는 머니허브 모바일 애플리케이션 (이하 “머니허브”)을 이용하는 이용자님들의 개인정보를 매우 중요하게 생각하며 아래와 같은 개인 정보 처리방침을 가지고 있습니다. 이 개인정보 처리방침은 개인정보와 관련한 법령 또는 지침의 변경이 있는 경우 개정되고, 회사 정책의 변화에 따라 달라질 수 있으니 이용자님들께서는 개인정보 처리 방침을 수시로 확인하여 주시기 바랍니다.
        1. 개인정보의 수집•이용
        ...
        성명: 백진욱
        직위: 연구개발부문장
        전자우편: jinuk.baek@themoneyhub.com
        전화번호: 070-4367-0113
        FAX: 0504-393-9687
        ...
        시행일자: 2019년 1월 10일
                                   ...
                                   <div class="themoin-sms-request">
                                       <div id="code_dropdown" class="moin-input-group moin-dropdown">   
